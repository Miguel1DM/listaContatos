...
//Esses módulos são em geral as querySql nesessárias para fazerem os CRUDS nescessário no BD
module.exports = {
    
    //Esse módulo apenas envia o código de verificação apartir do email passado
